...
sidebar = tk.Frame(window, width=200, height=600 , bd=2)  # Raised border

# Sidebar buttons or options
sidebar_button1 = tk.Button(sidebar, text="Trading Practice", relief="raised", fg="Black", font=("Times", 12))
